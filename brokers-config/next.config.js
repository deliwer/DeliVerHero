 ...
 * or if the brokers portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps brokers.deliwer.com/ to the broker onboarding page.
         * The browser URL remains brokers.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/broker-onboard",
      },
      {
        /**
