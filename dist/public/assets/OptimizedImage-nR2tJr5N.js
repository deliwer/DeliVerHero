import{r as t,j as r}from"./index-Bmt5cSC4.js";function b({src:e,alt:c,className:d="",width:a,height:i,priority:f=!1}){const[m,l]=t.useState(""),[s,x]=t.useState(!1),[g,u]=t.useState(!1),o=`data:image/svg+xml;base64,${btoa(`
