 ...
 * or if the earn portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps earn.deliwer.com/ to the earn/affiliate page.
         * The browser URL remains earn.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/earn",
      },
      {
        /**
