 ...
 * or if the Ejari portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps ejari.deliwer.com/ to the Ejari registration page.
         * The browser URL remains ejari.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/ejari-registration",
      },
      {
        /**
