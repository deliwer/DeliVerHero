 ...
 * or if the water portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps water.deliwer.com/ to the AquaCafe water filter page.
         * The browser URL remains water.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/aquacafe",
      },
      {
        /**
