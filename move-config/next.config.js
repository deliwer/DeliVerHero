 ...
 * or if the move portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps move.deliwer.com/ to the move-in services page.
         * The browser URL remains move.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/move-in-services",
      },
      {
        /**
