...
export default function HomeService() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Business Setup - NEW SECTION */}
      <section className="py-16 px-4 relative overflow-hidden" id="business-setup" style={{ backgroundImage: `url(${businessSetupImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="absolute inset-0 bg-gradient-to-r from-black/85 via-black/75 to-black/40"></div>
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/relocate/business-setup">
                  <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-8 h-14 rounded-full shadow-lg transition-all">
