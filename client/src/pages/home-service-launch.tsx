        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-black mb-4 text-white">
              JVC Move-In Starter — <span className="text-cyan-400">AED 99</span>
            </h2>
            <p className="text-xl text-gray-200 font-medium">Designed for residents who just got their keys.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div className="flex gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all">
                <div className="w-12 h-12 rounded-xl bg-cyan-400/20 flex items-center justify-center shrink-0">
                  <Sparkles className="w-6 h-6 text-cyan-400" />
                </div>
                <div>
                  <h4 className="font-bold text-xl text-white">Move-in guidance</h4>
                  <p className="text-gray-200">Expert advice for your first days</p>
                </div>
              </div>
              <div className="flex gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all">
                <div className="w-12 h-12 rounded-xl bg-cyan-400/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-xl text-white">Water filtration setup check</h4>
                  <p className="text-gray-200">Full assessment of your home's water</p>
                </div>
              </div>
              <div className="flex gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all">
                <div className="w-12 h-12 rounded-xl bg-cyan-400/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-xl text-white">Essential services coordination</h4>
                  <p className="text-gray-200">We handle the boring stuff for you</p>
                </div>
              </div>
              <div className="flex gap-4 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all">
                <div className="w-12 h-12 rounded-xl bg-cyan-400/20 flex items-center justify-center shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-xl text-white">Priority WhatsApp support</h4>
                  <p className="text-gray-200">Direct line to our concierge team</p>
                </div>
              </div>
            </div>
            <Card className="bg-gradient-to-br from-cyan-500 to-blue-600 text-white p-8 md:p-12 text-center h-full flex flex-col justify-center border-0 shadow-2xl">
              <h3 className="text-3xl font-black mb-4">Exclusive Launch Access</h3>
              <p className="text-white/90 mb-8 text-lg leading-relaxed">
                This offer is not public and available only through our launch partners.
              </p>
              <Link href="/residence/move-in-services">
                <Button variant="secondary" size="lg" className="w-full text-xl h-14 font-black hover-elevate active-elevate-2 shadow-lg bg-white text-cyan-600 hover:bg-gray-100">
                  Activate Offer Now
                </Button>
              </Link>
            </Card>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="inline-flex items-center gap-2 bg-emerald-500/20 text-emerald-400 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-bold">EXCLUSIVE MEMBERSHIP</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-black mb-6">AquaCafe Loyalty Journey</h2>
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Join an exclusive network of Dubai residents prioritizing health, sustainability, and smart living. Your membership unlocks priority support and community perks.
              </p>
              <ul className="space-y-4 mb-10">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-400 mt-1 shrink-0" />
                  <span className="text-lg">Priority installation for all water systems</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-400 mt-1 shrink-0" />
                  <span className="text-lg">Exclusive invitations to community events</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-emerald-400 mt-1 shrink-0" />
                  <span className="text-lg">Monthly rewards and partner discounts</span>
                </li>
              </ul>
              <Link href="/aquacafe">
            ...
            <div className="order-1 md:order-2">
              <div className="relative group">
                ...
                <img 
                  ...
                  data-testid="img-membership-card"
                />
              </div>
            </div>
          </div>
