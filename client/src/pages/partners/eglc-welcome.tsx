...
export default function EGLCWelcome() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEOMeta 
        title="Welcome EGLC | Earn 20% on Every Referral | DeliWer"
        description="Welcome to DeliWer's partner program. Earn AED 79.80 per booking referral. Track your conversions in real-time."
      />
      <Navigation />

      <section className="py-32 px-4 bg-gradient-to-b from-orange-500/10 to-transparent pt-32">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            <h1 className="text-6xl font-black uppercase">
              Welcome <span className="text-orange-500">EGLC</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mt-12">
            <Card className="bg-orange-900/40 border-orange-500/50 p-6">
              <Users className="w-10 h-10 text-orange-400 mb-3" />
              <p className="font-bold mb-1">Your Partner Code</p>
              <code className="text-orange-300 font-mono">eglc</code>
            </Card>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-black uppercase mb-12 text-center">How It Works for EGLC</h2>
            ...
            {[
              {
                ...
                desc: "Your unique referral link: https://deliwer.com/start?ref=eglc&agent=YOUR_NAME"
              },
              {
                num: "2",
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex gap-6 bg-slate-900/50 border border-orange-500/30 rounded-xl p-6"
              >
                <div className="text-3xl font-black text-orange-400 flex-shrink-0">{item.num}</div>
                <div>
      ...
      {/* CTA */}
      <section className="py-24 px-4 bg-gradient-to-r from-orange-950/30 to-slate-950 border-t border-orange-500/20">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link href="/partners">
              <Button size="lg" className="bg-orange-600 hover:bg-orange-500 font-black h-14 px-12 text-lg">
                Manage Your Referrals →
              </Button>
            </Link>
            <Link href="/partner-program">
              <Button size="lg" variant="outline" className="border-orange-500/50 text-orange-300 bg-orange-500/10 hover:bg-orange-500/20 font-black h-14 px-12 text-lg">
