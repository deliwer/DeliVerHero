...
export default function DeBacciWelcome() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEOMeta 
        title="Welcome DeBacci Capital | Earn 20% on Every Referral | DeliWer"
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            <h1 className="text-6xl font-black uppercase">
              Welcome <span className="text-blue-500">DeBacci Capital</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mt-12">
            <Card className="bg-blue-900/40 border-blue-500/50 p-6">
              <Users className="w-10 h-10 text-blue-400 mb-3" />
              <p className="font-bold mb-1">Your Partner Code</p>
              <code className="text-blue-300 font-mono">debacci</code>
            </Card>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-black uppercase mb-12 text-center">How It Works for DeBacci</h2>
            ...
            {[
              {
                ...
                desc: "Your unique referral link: https://deliwer.com/start?ref=debacci&agent=YOUR_NAME"
              },
              {
                num: "2",
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex gap-6 bg-slate-900/50 border border-blue-500/30 rounded-xl p-6"
              >
                <div className="text-3xl font-black text-blue-400 flex-shrink-0">{item.num}</div>
                <div>
