                              ...
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {m.result && (
                                  <div className="flex gap-1">
                                    ...
                                    <a
                                      href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`${window.location.origin}/league`)}&title=${encodeURIComponent(`${m.home_team} vs ${m.away_team} — Result`)}&summary=${encodeURIComponent(`🏆 ${m.result}\n\n${m.home_team} vs ${m.away_team}${m.match_date ? ` · ${m.match_date}` : ""}\n\nBrokers Night Cricket League UAE 2026 — full standings at the link.`)}`}
                                      target="_blank"
                                      rel="noopener noreferrer"
                      ...
                      {lastSavedResult && (
                        <div className="bg-emerald-950/50 border border-emerald-500/30 rounded-2xl p-4">
                          ...
                          <div className="flex gap-2 flex-wrap">
                            ...
                            <a
                              href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`${window.location.origin}/league`)}&title=${encodeURIComponent(`Match Result: ${lastSavedResult.home_team} vs ${lastSavedResult.away_team}`)}&summary=${encodeURIComponent(`🏆 ${lastSavedResult.result}\n\nBrokers Night Cricket League UAE 2026 — ${lastSavedResult.home_team} vs ${lastSavedResult.away_team}${lastSavedResult.match_date ? ` · ${lastSavedResult.match_date}` : ""}. UAE's premier real estate networking cricket league. Full standings at the link.`)}`}
                              target="_blank"
                              rel="noopener noreferrer"
