      ...
      <div className="bg-[#0a0f1a] text-white overflow-x-hidden">
        ...
        <section id="register" className="py-24 bg-gradient-to-b from-[#0d1420] to-[#0a0f1a] px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-6 bg-[#25D366]/8 border border-[#25D366]/25 rounded-2xl p-5">
              <p className="text-center text-sm font-black text-white mb-1">Already registered? Invite your teammates</p>
              <p className="text-center text-xs text-slate-500 mb-4">Share a pre-written WhatsApp message — your players just tap and join.</p>
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(`${window.location.origin}/league`);
                  }}
