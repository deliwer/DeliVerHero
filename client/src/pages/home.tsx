...
import { Flame, Clock, TrendingUp, Play, Building, Heart, Users, Award, ChevronRight, Handshake, ShoppingCart, ChefHat, CheckCircle, Gift, Crown, Trophy } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* 🎮 GAMING ENTRY GATEWAY - Main Play Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-purple-900 via-slate-900 to-purple-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-purple-800/50 to-purple-900/50 rounded-2xl p-8 border border-purple-500/30 hover:scale-105 transition-all">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 text-center">Tombola Spins</h3>
              <p className="text-gray-300 mb-6 text-center">
                Spin the Planet Points wheel to win instant rewards, unlock achievements, and multiply your impact
              </p>
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-purple-400 mb-1">23</div>
                <div className="text-sm text-gray-400">Free Spins Available</div>
              </div>
              <Link href="/play">
                <Button className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-bold">
                  🎰 Spin Now
                </Button>
              </Link>
            </div>
            ...
            {/* Achievements System */}
            <div className="bg-gradient-to-br from-hero-green-800/50 to-hero-green-900/50 rounded-2xl p-8 border border-hero-green-500/30 hover:scale-105 transition-all">
              <div className="w-20 h-20 bg-hero-green-500/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-hero-green-500/50">
                <Trophy className="w-10 h-10 text-hero-green-400" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 text-center">Achievements</h3>
              <p className="text-gray-300 mb-6 text-center">
                Unlock badges and earn bonus points through sustainable actions and milestones
              </p>
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-hero-green-400 mb-1">12/50</div>
                <div className="text-sm text-gray-400">Achievements Unlocked</div>
              </div>
              <Link href="/play">
                <Button className="w-full bg-gradient-to-r from-hero-green-600 to-hero-green-700 hover:from-hero-green-700 hover:to-hero-green-800 text-white font-bold">
                  🏆 View Progress
                </Button>
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-800/50 to-amber-900/50 rounded-2xl p-8 border border-amber-500/30 hover:scale-105 transition-all">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 text-center">Leaderboards</h3>
              <p className="text-gray-300 mb-6 text-center">
                Compete with Dubai's sustainability champions and climb the community rankings
              </p>
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-amber-400 mb-1">#47</div>
                <div className="text-sm text-gray-400">Current Ranking</div>
              </div>
              <Link href="/play">
                <Button className="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white font-bold">
                  📊 View Leaderboard
                </Button>
              </Link>
            </div>
          ...
          {/* Current Stats & Call to Action */}
          <div className="bg-gradient-to-r from-slate-800/80 to-slate-700/80 rounded-3xl p-12 border border-slate-600/50 backdrop-blur-sm">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-purple-400 mb-2">1,247</div>
                <div className="text-gray-400">Your Planet Points</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400 mb-2">Bronze</div>
                <div className="text-gray-400">Hero Level</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-hero-green-400 mb-2">753</div>
                <div className="text-gray-400">Points to Silver</div>
              </div>
              <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Earn points through iPhone trades, water system purchases, and community missions. 
                <span className="text-amber-400 font-bold"> Join AquaCafe Loyalty to redeem your points for exclusive rewards!</span>
              </p>
              
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/play">
                  <Button className="bg-gradient-to-r from-purple-600 to-hero-green-600 hover:from-purple-700 hover:to-hero-green-700 text-white px-8 py-4 text-xl font-bold shadow-lg hover:shadow-purple-500/20 transition-all">
                    <Gift className="w-6 h-6 mr-2" />
                    🎮 Start Playing Now
                  </Button>
                </Link>
                <Link href="/aquacafe">
                  <Button variant="outline" className="border-amber-500 text-amber-300 hover:bg-amber-500/10 px-8 py-4 text-xl border-2">
