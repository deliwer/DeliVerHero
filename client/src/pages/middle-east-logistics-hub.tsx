...
const FAQS = [
  ...
  { q: "How can I become a freight broker for ChainTrack?", a: "Register free via WhatsApp (+971523906019). No logistics experience, UAE residency, or upfront investment required. The process: (1) Register on WhatsApp. (2) Find a shipper (anyone moving cargo to/from ChainTrack's corridors). (3) Send the enquiry (origin, destination, weight, cargo type). (4) ChainTrack quotes, routes, handles customs, and delivers. (5) You earn 5% gross commission within 30 days of delivery. Corridor Captains who build a sub-broker network earn an additional 1% override." },
...
const WA = "https://wa.me/971523906019?text=Middle%20East%20Logistics%20Hub%20enquiry%20via%20ChainTrack";
        ...
        <div className="max-w-5xl mx-auto">
          <FadeUp className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="border border-amber-500/25 bg-amber-950/20 rounded-2xl p-7">
              ...
              {[
                { step: "1", act: "WhatsApp +971523906019", note: "Free. No form. 2 minutes." },
