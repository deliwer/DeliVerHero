    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <section className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 bg-gradient-to-r from-amber-600/20 to-orange-600/20 border border-amber-500/30 rounded-2xl p-6 text-center">
          ...
          <p className="text-gray-300 mb-4">Get started with our exclusive AED 1299 starter kit featuring free gifts and Bakers Kitchen partnership</p>
