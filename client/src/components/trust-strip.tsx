      ...
      {showContact && (
        <>
          ...
          <Link href="/concierge-pricing">
            <span className={`cursor-pointer ${textClass} hover:text-white transition-colors uppercase tracking-widest text-[10px] font-black`}>Concierge</span>
          </Link>
          <Link href="/partners">
          ...
          <Link href="/consult">
            <span className={`cursor-pointer text-emerald-400 hover:text-emerald-300 transition-colors uppercase tracking-widest text-[10px] font-black border border-emerald-500/30 px-2 py-0.5 rounded`}>Consult</span>
          </Link>
