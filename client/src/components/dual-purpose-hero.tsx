          ...
          <div className="max-w-xl mx-auto space-y-4">
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <p className="text-[14px] text-white/80 font-medium">
                Already moved in? <Link href="/residence/move-in-services" className="text-emerald-400 hover:underline inline-flex items-center gap-1 font-bold">Explore Home Services <ArrowRight className="w-3 h-3" /></Link>
              </p>
            </div>
          </div>
        </div>
