 ...
 * or if the rentals portal is ever migrated to a Next.js standalone project.
 *
...
const nextConfig = {
  async rewrites() {
    return [
      {
        /**
         * Root rewrite — maps rentals.deliwer.com/ to the Flex Living rentals page.
         * The browser URL remains rentals.deliwer.com; content comes from deliwer.com.
         */
        source: "/",
        destination: "https://deliwer.com/flexible-rentals",
      },
      {
        /**
